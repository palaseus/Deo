...
public:
     ...
     */
    uint32_t getMiningDifficulty() const;
    ...
    /**
     * @brief Get delegations for a validator
     * @param validator_address Validator address
     * @return Map of delegator addresses to delegation amounts
     */
    std::map<std::string, deo::vm::uint256_t> getDelegations(const std::string& validator_address) const;
    
    /**
     * @brief Get slashing history for a validator
     * @param validator_address Validator address
    ...
    /**
     * @brief Update epoch
     * @param epoch_number New epoch number
     */
    void updateEpoch(uint64_t epoch_number);
